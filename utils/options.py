...
def args_parser():
    ...
    parser.add_argument("--beta", type=float, default=1, help="Average moving parameter for pFedMe, or Second learning rate of Per-FedAvg, or alpha for APFL")
    parser.add_argument("--L_k", type=float, default=0.004, help="Regularization term")
    parser.add_argument("--num_global_iters", type=int, default=200)
    parser.add_argument("--local_epochs", type=int, default = 5)
    parser.add_argument("--optimizer", type=str, default="SGD")
    parser.add_argument("--algorithm", type=str, default="SSGD",choices=["pFedMe", "pFedMe_p", "PerAvg", "FedAvg", "FedU", "Mocha", "Local" , "Global", "FedAFL", "SCAFFOLD", "FedProx", "APFL", "FedRep"]) 
    ...
    parser.add_argument("--personal_learning_rate", type=float, default=0.01, help="Persionalized learning rate to calculate theta approximately using K steps")
