...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="SSGD",choices=["pFedMe", "PerAvg", "FedAvg", "SSGD", "mSSGD","mFedAvg"]) 
    parser.add_argument("--numusers", type = float, default = 0.1, help="Number of Users per round")
